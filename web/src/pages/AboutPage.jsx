      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-1 pt-24 pb-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 mt-12">About ORBITL</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-24">
              ...
              >
                <div className="aspect-video rounded-2xl overflow-hidden bg-muted relative">
                  <img
                    src="https://github.com/kasidish/ORBITL/blob/main/web/src/images/2048-1365-max%20(2).jpg"
